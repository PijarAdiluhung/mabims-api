...
| `GET /api/v1/hilal/map?month=&year=` | Hilal visibility map PNG (720×1280): the archipelago visible region, 95 display points and the deciding-site table. Pre-generated for 1445–1455 H, rendered on demand outside that range. | 30/hour |
