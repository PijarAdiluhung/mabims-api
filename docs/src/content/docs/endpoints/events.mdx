---
title: GET /events
description: "Tanggal [hari besar Islam](https://en.wikipedia.org/wiki/Islamic_holidays) (1 Muharram, Maulid, Awal Ramadan, Idul Fitri, Idul Adha) dari tabel MABIMS, diperluas dengan data komputasi di luar cakupan tabel."
---
...
<TestRequest path="/api/v1/events" label="Coba /events" />
...
Neo MABIMS ([kriteria resmi](https://mui.or.id/baca/berita/mengenal-kriteria-hilal-mabims-standard-penentuan-awal-bulan-hijriyah-pemerintah-indonesia)) (ketinggian hilal ≥ 3° dan elongasi ≥ 6.4° saat matahari terbenam lokal, dievaluasi
di titik-titik pengamatan pesisir di seluruh Indonesia),
