...
**mabims-hijri** is a JavaScript/TypeScript npm package that works offline. It bundles MABIMS 2024-2026 data directly in the package. No API key, no registration.
...
1. MABIMS 2024-2026 data is bundled directly in the package (~70KB)
