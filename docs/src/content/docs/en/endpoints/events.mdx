---
title: GET /events
description: "[Islamic observance](https://en.wikipedia.org/wiki/Islamic_holidays) dates (1 Muharram, Maulid, Ramadan start, Eid al-Fitr, Eid al-Fadha) from the MABIMS table, extended with computed dates beyond table coverage."
---
...
<TestRequest path="/api/v1/events" label="Try /events" />
